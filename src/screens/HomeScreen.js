...
const HomeScreen = ({navigation}) => {
  ...
  const [drone2, setDrone2] = useState({id:2, homePos:'52S CF 93515 81121', targetPos:'52S CE 31126 99272', batt:69, gpsErr:false, targetErr:true, distErr:true});
  const [drone3, setDrone3] = useState({id:3, homePos:'', targetPos:'52S CF 99803 80999', batt:30, gpsErr:true, targetErr:false, distErr:true});
  const [drone4, setDrone4] = useState({id:4, homePos:'52S CF 93515 81121', targetPos:'', batt:11, gpsErr:true, targetErr:true, distErr:false});
